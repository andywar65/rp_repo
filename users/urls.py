...
from .views import (FrontLoginView, FrontLogoutView, FrontPasswordResetView,
    ...
    TemplateDeletedChildView, ProfileReleaseView, TemplateReleasedView)
...
urlpatterns = [
    ...
    path('profile/<int:pk>/delete/', ProfileDeleteView.as_view(),
        name='profile_delete'),
    path('profile/<int:pk>/delete_child/', ProfileDeleteChildView.as_view(),
    ...
    path('profile/released/', TemplateReleasedView.as_view(),
        name='profile_released'),
